...
-- Table: user
CREATE TABLE IF NOT EXISTS user (id INTEGER PRIMARY KEY NOT NULL UNIQUE, name TEXT NOT NULL, email TEXT NOT NULL UNIQUE, created_at INTEGER (0) NOT NULL, updated_at INTEGER (0) NOT NULL);
